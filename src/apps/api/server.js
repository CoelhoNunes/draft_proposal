  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert FedRAMP proposal assistant. Help users with security controls, compliance documentation, and proposal writing. Be concise and professional."
        },
        {
          role: "user",
          content: message
